...
<body>
        ...
        <div class="container-fluid">
    		...
    		<ul class="nav navbar-nav">
				...
				<li class="dropdown active">
					...
					<li class="active"><a href="./nested.php">NESTED - GROUP BY</a></li>
					</ul>
				</li>
    		</ul>
        </div>
    ...
    <form action="./nested.php" method="GET" class="form">
        <div class="form-group">
			...
			<p>SELECT P.Psize, COUNT(P.id) <br>
				...
				WHERE P.id IN (<br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SELECT T1.id<br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FROM isType T1, isType T2<br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WHERE T1.id = T2.id and T1.TName != T2.TName)<br>
				GROUP BY P.Psize;<br>
			</p>
	...
	<?php
		...
		function handlePokemonProjectRequest() {
			global $db_conn;			
			printResult(executePlainSQL("SELECT P.Psize, COUNT(P.id)
										FROM Pokemon P
										WHERE P.id IN (
											SELECT T1.id
